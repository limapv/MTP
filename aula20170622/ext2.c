...
float det(float ** M, int ordem){
    ...
    if(ordem == 1)return (M[0][0]*M[1][1]*M[2][2] + M[0][1]*M[1][2]*M[2][0] + M[0][2]*M[1][0]*M[2][1]) - (M[0][0]*M[1][2]*M[2][1] + M[0][1]*M[1][0]*M[2][2] + M[0][2]*M[1][1]*M[2][0]);
    i = 0;
    for(j = 0; j < ordem; j++){
